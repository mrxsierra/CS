...
- **01 DSA**: Shifted from memorization to **Patterns Over Memorization** (12 core patterns).
- **02 SDLC & DevOps**: Focus on **Git Architecture** (Interactive Rebase, Trunk-based development) and **CI/CD Pipelines**.
...
### 4. 04 Company Guides
Placeholders for company-specific interview patterns.

### 5. 05 Templates
Standardized markdown templates to ensure consistency across the vault.
